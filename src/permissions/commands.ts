  ...
  handler: async (context: CommandContext): Promise<CommandResult> => {
    ...
    switch (subcommand) {
      case "mode": {
        ...
        const mode = subArgs[0] as PermissionMode;
        const validModes: PermissionMode[] = ["default", "acceptEdits", "plan", "auto", "bypassPermissions"];
      ...
      case "add": {
        ...
        const action = subArgs[1] as "allow" | "deny";
        const scope = (subArgs[2] as "user" | "project" | "local") || "project";
