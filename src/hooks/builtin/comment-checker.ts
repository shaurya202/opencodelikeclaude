...
import { PostToolUseHookInput, PostToolUseHookOutput } from "../types";
...
hookRegistry.register<PostToolUseHookInput, PostToolUseHookOutput>(
  "post-tool-use",
  async (input) => {
    ...
    const suspiciousLines: { line: number; text: string }[] = [];
