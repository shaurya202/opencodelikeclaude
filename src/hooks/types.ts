...
export type HookInput =
  ...
  | ToolExecuteBeforeHookInput
  | ToolExecuteAfterHookInput
  | TextCompleteHookInput
...
export type HookOutput =
  ...
  | ChatParamsHookOutput
  | PermissionAskHookOutput
  | ToolExecuteBeforeHookOutput
  | ToolExecuteAfterHookOutput
  | TextCompleteHookOutput
  | SessionCompactingHookOutput
  | ConfigHookOutput
  | ToolHookOutput
  | EventHookOutput;

export type HookHandler<T extends HookInput = HookInput, R extends HookOutput = HookOutput> = (
  input: T
) => Promise<R> | R;
