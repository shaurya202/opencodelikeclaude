...
export const statusCommand: CommandDefinition = {
  ...
  handler: async (context: CommandContext): Promise<CommandResult> => {
    ...
    if (flags.full) {
      ...
      if (detect.hasSettings) compatParts.push("settings");
      if (detect.hasCommands) compatParts.push("commands");
      if (detect.hasSkills) compatParts.push("skills");
      if (detect.hasAgents) compatParts.push("agents");
      if (detect.hasMcp) compatParts.push("mcp");
