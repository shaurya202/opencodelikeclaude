...
export function compactSession(sessionId, options = {}) {
...
function generateCompactedSummary(messages, focus, customPrompt) {
    if (customPrompt) {
        return customPrompt;
    }
...
function estimateTokensSaved(originalMessages, compactedContent) {
