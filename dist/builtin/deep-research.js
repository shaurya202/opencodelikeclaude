...
export const deepResearchCommand = {
    name: "deep-research",
    ...
    handler: async (context) => {
        ...
        if (flags.list) {
            ...
            if (instances.length === 0)
                return { output: "No research instances." };
        ...
        if (flags.get) {
            const instance = researchRunner.getInstance(flags.get);
            if (!instance)
                return { error: "Research instance not found", exitCode: 1 };
