...
export const powerupCommand = {
    ...
    handler: async (context) => {
        ...
        if (flags.get) {
            ...
            if (!lesson)
                return { error: `Lesson "${flags.get}" not found. Use /powerup --list to see available lessons.`, exitCode: 1 };
        ...
        if (flags.complete) {
            ...
            if (!lesson)
                return { error: `Lesson "${flags.complete}" not found`, exitCode: 1 };
