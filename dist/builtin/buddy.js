...
export const buddyCommand = {
    ...
    handler: async (context) => {
        ...
        if (flags.mood) {
            const validMoods = ["happy", "excited", "thinking", "working", "sleepy", "celebrate"];
            const mood = flags.mood;
        ...
        if (flags.character) {
            const found = buddyPet.setCharacter(flags.character);
            if (!found) {
